...
Not published. This version exists to exercise the release pipeline end to end
after the repository split, from the first tag through to the site promotion,
without shipping anything. The first release actually published from this
repository will be 1.0.0.
